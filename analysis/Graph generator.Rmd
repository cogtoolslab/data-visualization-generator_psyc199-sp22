...
Questions_generator <- function(fp) {
  ...
  df_sub <- cbind(graph_types, comb_N_NA)
                  
  df_sub_Q$v1, df_sub_Q$v2, df_sub_Q$v3, df_sub_Q$v4
  ...
  Q_N_NA <- c(
    ...
    'sprintf("What is the proportion of %s between %d and %d?", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$v2)',
    
    # VLAT: Make Comparisons (e.g. More people have rated the taxi between 4.6 and 4.8 than between 4.2 and 4.4)
    'sprintf("The proportion in %s between %d and %d is larger than between %d and %d.", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$v2, df_sub_Q$v3, df_sub_Q$v4)'
  )
  ...
  Q_N_N <- c(
    ...
    'sprintf("What is the best prediction of %s if %s is %d?", df_sub_Q$X2, df_sub_Q$X1, df_sub_Q$v0)',
    ...
    'sprintf("A group of points are gathered around the %s of %d and the %s of %d.", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$X2, df_sub_Q$v2)',
    
    # VLAT: Make comparisons (e.g. The weights for males with the height of 188 cm are al the same.)
    'sprintf("The %s with the %s of %d are all the same.", df_sub_Q$X2, df_sub_Q$X2, df_sub_Q$v0)'
  )
