...
graph_saver <- function(df, vars, varstype, graph_type, dfname, savepath){ #prefix
  ...
  ggsave(filename=paste0(dfname, "-", graph_type, "-", paste(vars, collapse="__"), ".png"), plot=plot, path=savepath)
...
Questions_generator <- function(fp) {
  ...
  Q_N_NA <- c(
    ...
    'sprintf("What is the proportion of %s between %.4g and %.4g?", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$v2)',
    
    # VLAT: Make Comparisons (e.g. More people have rated the taxi between 4.6 and 4.8 than between 4.2 and 4.4)
    'sprintf("The proportion in %s between %.4g and %.4g is larger than between %f and %f.", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$v2, df_sub_Q$v3, df_sub_Q$v4)'
  )
  ...
  Q_C_NA <- c(
    ...
    'sprintf("What is the percentage of %s in %s?", df_sub_Q$l1, df_sub_Q$X1)',
    ...
    'sprintf("How many groups in %s has a larger proportion than %s?", df_sub_Q$X1, df_sub_Q$l1)',
    # X (Count): Compare smaller
    'sprintf("How many groups in %s has a smaller proportion than %s?", df_sub_Q$X1, df_sub_Q$l1)',
    ...
    'sprintf("What is the range of the proportion of each group in %s.", df_sub_Q$X1)'
  )
  ...
  Q_N_N <- c(
    ...
    'sprintf("What is the best prediction of %s if %s is %.4g?", df_sub_Q$X2, df_sub_Q$X1, df_sub_Q$v0)',
    ...
    'sprintf("There is no linear correlation between %s and %s.", df_sub_Q$X1, df_sub_Q$X2)',
    ...
    'sprintf("What is the %s for a point which lies outside the others the most?", df_sub_Q$X2)',
    
    # VLAT: Find clusters (e.g. A group of males are gathered around the height of 176 cm and the weight of 70 kg.)
    'sprintf("A group of points are gathered around the %s of %.4g and the %s of %.4g.", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$X2, df_sub_Q$v2)',
    
    # VLAT: Make comparisons (e.g. The weights for males with the height of 188 cm are al the same.)
    'sprintf("The %s with the %s of %.4g are all the same.", df_sub_Q$X2, df_sub_Q$X1, df_sub_Q$v0)'
  )
  ...
  Q_C_C <- c(
    ...
    'sprintf("What is the percentage of the combination of %s and %s whose proportion is the highest?", df_sub_Q$X1, df_sub_Q$X2)',
    'sprintf("What is the percentage of the combination of %s and %s whose proportion is the lowest?", df_sub_Q$X1, df_sub_Q$X2)',
    ...
    # VLAT: Find Extremum -----
    'sprintf("In the %s %s group, which group in %s has the highest proportion?", df_sub_Q$l1_1, df_sub_Q$X1, df_sub_Q$X2)',    
    'sprintf("In the %s %s group, which group in %s has the lowest proportion?", df_sub_Q$l1_1, df_sub_Q$X1, df_sub_Q$X2)',   

    'sprintf("In the %s %s group, which group in %s has the highest proportion?", df_sub_Q$l2_1, df_sub_Q$X2, df_sub_Q$X1)',    
    'sprintf("In the %s %s group, which group in %s has the lowest proportion?", df_sub_Q$l2_1, df_sub_Q$X2, df_sub_Q$X1)', 
    
    'sprintf("Which combination of %s and %s has the highest proportion?", df_sub_Q$X1, df_sub_Q$X2)',
    'sprintf("Which combination of %s and %s has the lowest proportion?", df_sub_Q$X1, df_sub_Q$X2)',
    
    # VLAT: Make comparisons -----
    'sprintf("In the %s %s group, the %s %s group has a larger proportion than %s.", df_sub_Q$l1_1, df_sub_Q$X1, df_sub_Q$l2_1, df_sub_Q$X2, df_sub_Q$l2_2)',    
    'sprintf("In the %s %s group, the %s %s group has a smaller proportion than %s.", df_sub_Q$l1_1, df_sub_Q$X1, df_sub_Q$l2_1, df_sub_Q$X2, df_sub_Q$l2_2)',     
    
    # Add VLAT -------------------------------------------------------------
    # VLAT: Retrieve value (relative value)
    'sprintf("What is the proportion of %s %s in %s %s", df_sub_Q$l2_1, df_sub_Q$X2, df_sub_Q$l1_1, df_sub_Q$X1)',       
    # VLAT: Make comparisons (relative value)
    'sprintf("The ratio of the proportion of %s to %s in %s %s is higher than of %s %s.", df_sub_Q$l2_1, df_sub_Q$l2_2, df_sub_Q$l1_1, df_sub_Q$X1, df_sub_Q$l1_2, df_sub_Q$X1)'
  )
  ...
  Q_C_N_1 <- c(
    'sprintf("What is the range of %s in %s of %s?", df_sub_Q$X2, df_sub_Q$l1,  df_sub_Q$X1)',
    'sprintf("What is the standard deviation of %s in %s of %s?", df_sub_Q$X2, df_sub_Q$l1,  df_sub_Q$X1)',
    'sprintf("What is the mean of %s in %s of %s?", df_sub_Q$X2, df_sub_Q$l1,  df_sub_Q$X1)',
    'sprintf("What is the median of %s in %s of %s?", df_sub_Q$X2, df_sub_Q$l1,  df_sub_Q$X1)',
    'sprintf("What is the maximum of %s in %s of %s?", df_sub_Q$X2, df_sub_Q$l1,  df_sub_Q$X1)',
    'sprintf("What is the minimum of %s in %s of %s?", df_sub_Q$X2, df_sub_Q$l1,  df_sub_Q$X1)',
    ...
    'sprintf("How many groups in %s is the median of %s larger than %s?", df_sub_Q$X1, df_sub_Q$X2, df_sub_Q$l1)',
    'sprintf("How many groups in %s is the median of %s smaller than %s?", df_sub_Q$X1, df_sub_Q$X2, df_sub_Q$l1)',
  ...
  Q_C_N_2 <- c(
    ...
    # VLAT: Retrieve Value
    'sprintf("What is the average %s in the %s %s?", df_sub_Q$X2, df_sub_Q$l1, df_sub_Q$X1)',
    
    # VLAT: Find Extremum
    'sprintf("In which group of %s has the highest average %s?", df_sub_Q$X1, df_sub_Q$X2)',
    'sprintf("In which group of %s has the lowest average %s?", df_sub_Q$X1, df_sub_Q$X2)',
    
    # VLAT: Make Comparisons
    'sprintf("In the %s %s group, the average %s is higher than of %s group.", df_sub_Q$l1, df_sub_Q$X1, df_sub_Q$X2, df_sub_Q$l2)',  
    'sprintf("In the %s %s group, the average %s is lower than of %s group.", df_sub_Q$l1, df_sub_Q$X1, df_sub_Q$X2, df_sub_Q$l2)',  
    
    # Add VLAT -----------------------------------------------------------------
    # VLAT: Determine Range
    'sprintf("What is the range of average %s among each group in %s", df_sub_Q$X2, df_sub_Q$X1)'
  )
