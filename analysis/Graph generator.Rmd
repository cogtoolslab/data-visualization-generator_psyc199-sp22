...
Questions_generator <- function(fp) {
  ...
  Q_N_NA <- c(
    ...
    'sprintf("The proportion in <strong>%s</strong> between %.4g and %.4g is larger than between %f and %f.", df_sub_Q$X1, df_sub_Q$v1, df_sub_Q$v2, df_sub_Q$v3, df_sub_Q$v4)'
  )
